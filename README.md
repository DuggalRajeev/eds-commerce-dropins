...
- Preview: https://main--eds-commerce-dropins--DuggalRajeev.hlx.page/
- Live: https://main--eds-commerce-dropins--DuggalRajeev.hlx.live/
...
1. Open the `eds-commerce-dropins` directory in your favorite IDE and start coding :)
